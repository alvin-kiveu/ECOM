...
Product Price : <del> Ksh $pro_price </del><br>

Product Sale Price : Ksh $pro_psp_price
...
Bundle Price : <del> Ksh $pro_price </del><br>

Bundle Sale Price : Ksh $pro_psp_price
                    ...
                    if ($all_attributes_selected) {
                      ...
                      if ($status == "product") {
                        ...
                        if ($variation_product_psp_price == 0) {
                          ...
                          echo " Product Price : Ksh $variation_product_price ";
                        } else {

                          echo "

Product Price : <del> Ksh $variation_product_price </del><br>

Product Sale Price : Ksh $variation_product_psp_price
...
Bundle Price : <del> Ksh $variation_product_price </del><br>

Bundle Sale Price : Ksh $variation_product_psp_price
            ...
            <?php if ($status == "product") { ?>
              ...
              while ($row_products = mysqli_fetch_array($run_products)) {
                ...
                if ($product_type != "variable_product") {
                  ...
                  $product_price = "Ksh $minimum_product_price - Ksh $maximum_product_price";
