...
if (!isset($_SESSION['admin_email'])) {
  ...
  $umspay_email = $row_payment_settings['umspay_email'];

  $umspay_account_id = $row_payment_settings['umspay_account_id'];

  $umspay_app_key = $row_payment_settings['umspay_app_key'];

  $umspay_currency_code = $row_payment_settings['umspay_currency_code'];
  ...
  $pesapal_currency_code = $row_payment_settings['pesapal_currency_code'];
...
?>
        ...
        <div class="panel-body"><!-- panel-body Starts -->
          ...
          <form class="form-horizontal payment-settings" method="post"><!-- form-horizontal Starts -->
            ...
            <div class="form-group"><!-- form-group Starts -->
              ...
              <div class="col-md-7">
                ...
                <label class="control-label">
                  ...
                  <input type="radio" name="paypal_sandbox" value="1" <?php if ($paypal_sandbox == 1) {
                                                                        echo "checked";
                                                                      } ?> required> On
                ...
                <label class="control-label">
                  ...
                  <input type="radio" name="paypal_sandbox" value="0" <?php if ($paypal_sandbox == 0) {
                                                                        echo "checked";
                                                                      } ?> required> Off
            ...
            <div class="form-group">
              <label class="col-md-3 control-label"> Enable PesaPal : </label>
              <div class="col-md-7">
                <select name="enable_pesapal" class="form-control">
                  <option value="yes" <?php if ($enable_pesapal == "yes") {
                                        echo "selected";
                                      } ?>> Yes </option>
                  <option value="no" <?php if ($enable_pesapal == "no") {
                                        echo "selected";
                                      } ?>> No </option>
                </select>
                <span id="helpBlock" class="help-block">
                  ALLOW Customers TO PAY USING PesaPal.
                </span>
              </div>
            </div>

            <div class="form-group">
              <label class="col-md-3 control-label"> PesaPal Enviroment : </label>
              <div class="col-md-7">
                <select name="pesapal_sandbox" class="form-control">
                  <option value="yes" <?php if ($pesapal_sandbox == "yes") {
                                        echo "selected";
                                      } ?>> Sandbox </option>
                  <option value="no" <?php if ($pesapal_sandbox == "no") {
                                        echo "selected";
                                      } ?>> Live </option>
                </select>
                <span id="helpBlock" class="help-block">
            ...
            <div class="form-group">
              <label class="col-md-3 control-label"> PesaPal Consumer Key : </label>
              <div class="col-md-7">
                <input type="text" name="pesapal_consumer_key" class="form-control" value="<?php echo $pesapal_consumer_key; ?>">
                <span id="helpBlock" class="help-block">
                  YOUR PesaPal CONSUMER KEY ASSIGNED TO YOU.
                </span>
              </div>
            ...
            <div class="form-group">
              <label class="col-md-3 control-label"> PesaPal Consumer Secret : </label>
              <div class="col-md-7">
                <input type="text" name="pesapal_consumer_secret" class="form-control" value="<?php echo $pesapal_consumer_secret; ?>">
                <span id="helpBlock" class="help-block">
                  YOUR PesaPal CONSUMER SECRET ASSIGNED TO YOU.
                </span>
              </div>
            ...
            <div class="form-group">
              <label class="col-md-3 control-label"> PesaPal Currency Code : </label>
              <div class="col-md-7">
                <input type="text" name="pesapal_currency_code" class="form-control" value="<?php echo $pesapal_currency_code; ?>">
              </div>
              <span id="helpBlock" class="help-block">
                CURRENCY USED FOR PesaPal PAYMENTS
              </span>
            ...
            <div class="form-group">
              <label class="col-md-3 control-label"> Enable UmsPay : </label>
              <div class="col-md-7">
                <select name="enable_umspay" class="form-control">
                  <option value="yes" <?php if ($enable_umspay == "yes") {
                                        echo "selected";
                                      } ?>> Yes </option>
                  <option value="no" <?php if ($enable_umspay == "no") {
                                        echo "selected";
                                      } ?>> No </option>
                </select>
                <span id="helpBlock" class="help-block">
                  ALLOW Customers TO PAY USING UmsPay.
                </span>
              </div>
            ...
            <div class="form-group">
              <label class="col-md-3 control-label"> UmsPay Email : </label>
              <div class="col-md-7">
                <input type="text" name="umspay_email" class="form-control" value="<?php echo $umspay_email; ?>">
                <span id="helpBlock" class="help-block">
                  Enter  UmsPay Accounts.
                </span>
              </div>

            <div class="form-group">
              <label class="col-md-3 control-label"> UmsPay Account ID : </label>
              <div class="col-md-7">
                <input type="text" name="umspay_account_id" class="form-control" value="<?php echo $umspay_account_id; ?>">
                <span id="helpBlock" class="help-block">
                  YOUR UmsPay ACCOUNT ID ASSIGNED TO YOU.
                </span>
              </div>
            </div>

            <div class="form-group">
              <label class="col-md-3 control-label"> UmsPay Api Key : </label>
              <div class="col-md-7">
                <input type="text" name="umspay_app_key" class="form-control" value="<?php echo $umspay_app_key; ?>">
                <span id="helpBlock" class="help-block">
                  YOUR UmsPay Api KEY ASSIGNED TO YOU.
                </span>
              </div>
            </div>

            <div class="form-group">
              <label class="col-md-3 control-label"> UmsPay Currency Code : </label>
              <div class="col-md-7">
                <input type="text" name="umspay_currency_code" class="form-control" value="<?php echo $umspay_currency_code; ?>">
                <span id="helpBlock" class="help-block">
                  CURRENCY USED FOR UmsPay PAYMENTS
                </span>
              </div>
            </div>
  ...
  if (isset($_POST['update_payment_settings'])) {
    ...
    $umspay_email = mysqli_real_escape_string($con, $_POST['umspay_email']);

    $umspay_account_id = mysqli_real_escape_string($con, $_POST['umspay_account_id']);

    $umspay_app_key = mysqli_real_escape_string($con, $_POST['umspay_app_key']);

    $umspay_currency_code = mysqli_real_escape_string($con, $_POST['umspay_currency_code']);

    $enable_umspay = mysqli_real_escape_string($con, $_POST['enable_umspay']);

    $pesapal_consumer_key = mysqli_real_escape_string($con, $_POST['pesapal_consumer_key']);

    $pesapal_sandbox = mysqli_real_escape_string($con, $_POST['pesapal_sandbox']);

    $pesapal_consumer_secret = mysqli_real_escape_string($con, $_POST['pesapal_consumer_secret']);

    $pesapal_currency_code = mysqli_real_escape_string($con, $_POST['pesapal_currency_code']);

    $enable_pesapal = mysqli_real_escape_string($con, $_POST['enable_pesapal']);


    $update_payment_settings = "update payment_settings set commission_percentage='$commission_percentage',minimum_withdraw_limit='$minimum_withdraw_limit',days_before_withdraw='$days_before_withdraw',enable_paypal='$enable_paypal',paypal_email='$paypal_email',paypal_currency_code='$paypal_currency_code',paypal_sandbox='$paypal_sandbox',paypal_app_client_id='$paypal_app_client_id',paypal_app_client_secret='$paypal_app_client_secret',enable_stripe='$enable_stripe',stripe_secret_key='$stripe_secret_key',stripe_publishable_key='$stripe_publishable_key',stripe_currency_code='$stripe_currency_code',umspay_email='$umspay_email',umspay_account_id='$umspay_account_id',umspay_app_key='$umspay_app_key',umspay_currency_code='$umspay_currency_code',enable_umspay='$enable_umspay',pesapal_consumer_key='$pesapal_consumer_key',pesapal_consumer_secret='$pesapal_consumer_secret',pesapal_sandbox='$pesapal_sandbox',pesapal_currency_code='$pesapal_currency_code',enable_pesapal='$enable_pesapal'";
...
alert('Payment Settings Has Been Updated Successfully.');
