...
$db = mysqli_connect("localhost", "root", "", "my_php_ecommerce_project");
...
function getPro()
{
    ...
    while ($row_customer_history = mysqli_fetch_array($run_customer_history)) {
        ...
        if (!isset($relevent_products["p_cat_ids"]) && !isset($relevent_products["cat_ids"])) {
    ...
    while ($row_products = mysqli_fetch_array($run_products)) {
        ...
        if (($product_type != "variable_product" && $stock_status == "outofstock") || ($product_type == "variable_product" && $instock == 0)) {
