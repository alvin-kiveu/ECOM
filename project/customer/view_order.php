      ...
      <div class="col-md-9"><!--- col-md-9 Starts -->
        ...
        <div class="box"><!-- box Starts -->
          ...
          if (isset($_GET['order_id'])) {
            ...
            $billing_first_name = isset($row_addresses["billing_first_name"]) ? $row_addresses["billing_first_name"] : '';
            $billing_last_name = isset($row_addresses["billing_last_name"]) ? $row_addresses["billing_last_name"] : '';
            $billing_address_1 = isset($row_addresses["billing_address_1"]) ? $row_addresses["billing_address_1"] : '';
            $billing_address_2 = isset($row_addresses["billing_address_2"]) ? $row_addresses["billing_address_2"] : '';
            $billing_city = isset($row_addresses["billing_city"]) ? $row_addresses["billing_city"] : '';
            $billing_postcode = isset($row_addresses["billing_postcode"]) ? $row_addresses["billing_postcode"] : '';
            $billing_country = isset($row_addresses["billing_country"]) ? $row_addresses["billing_country"] : '';
            $billing_state = isset($row_addresses["billing_state"]) ? $row_addresses["billing_state"] : '';
            $is_shipping_address = isset($row_addresses["is_shipping_address"]) ? $row_addresses["is_shipping_address"] : '';
            $shipping_first_name = isset($row_addresses["shipping_first_name"]) ? $row_addresses["shipping_first_name"] : '';
            $shipping_last_name = isset($row_addresses["shipping_last_name"]) ? $row_addresses["shipping_last_name"] : '';
            $shipping_address_1 = isset($row_addresses["shipping_address_1"]) ? $row_addresses["shipping_address_1"] : '';
            $shipping_address_2 = isset($row_addresses["shipping_address_2"]) ? $row_addresses["shipping_address_2"] : '';
            $shipping_city = isset($row_addresses["shipping_city"]) ? $row_addresses["shipping_city"] : '';
            $shipping_postcode = isset($row_addresses["shipping_postcode"]) ? $row_addresses["shipping_postcode"] : '';
            $shipping_country = isset($row_addresses["shipping_country"]) ? $row_addresses["shipping_country"] : '';
            $shipping_state = isset($row_addresses["shipping_state"]) ? $row_addresses["shipping_state"] : '';
          ...
          <table class="table border-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <th>Ksh <?php echo $items_subtotal; ?></th>
                  ...
                  ?>
                    ...
                    <tr><!-- tr Starts -->
                      ...
                      <td>
                        ...
                        <strong>Ksh <?php echo $order_total; ?></strong>
          ...
          <div class="row"><!-- row Starts -->
            ...
            <div class="col-sm-6">
              ...
              <address class="text-muted" style="font-size:15px;">
                ...
                echo $country_name = isset($row_country["country_name"]) ? $row_country["country_name"] : '';
