        ...
        <div class="col-md-12"><!-- col-md-12 Starts -->
          ...
          ?>
            ...
            <div class="alert alert-danger"><!-- alert alert-danger Starts -->
              ...
              <strong> Warning! </strong> Please Confirm Your Email Address, if you have not received a code;
        ...
        <div class="col-md-9"><!--- col-md-9 Starts -->
          ...
          <div class="box"><!-- box Starts -->
            ...
            if (isset($_GET['send_email'])) {
              ...
              $from = "amheretoconquer@gmail.com";

              $message = "

<h2>
Email Confirmation By Conquerer $c_name
</h2>

<a href='localhost/ecommerce_project/customer/my_account.php?$customer_confirm_code'>
...
";
              ...
              echo "<script>alert('A Confirmation Email Has Been sent to you, check your inbox')</script>";
