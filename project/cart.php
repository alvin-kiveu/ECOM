              ...
              <table class="table"><!-- table Starts -->
                ...
                <tfoot><!-- tfoot Starts -->
                  <tr>
                    ...
                    <th colspan="2"> <span class="subtotal-cart-price">Ksh <?php echo $total; ?></span>.00 </th>
                  </tr>
                </tfoot><!-- tfoot Ends -->
              </table><!-- table Ends -->
...
";
                ...
                <tr class="total">
                  ...
                  <?php if (count($physical_products) > 0) { ?>
                    ...
                    <th class="total-cart-price">Ksh <?php echo $total_cart_price; ?>.00</th>

                  <?php } else { ?>

                    <th class="total-cart-price">Ksh <?php echo $total; ?>.00</th>
    ...
    $(document).ready(function() {
      $(document).on('keyup', '.quantity', function() {
        ...
        if ($("input[name=shipping_type]").length) {
          ...
          post_data.shipping_type = shipping_type;
          post_data.shipping_cost = shipping_cost;
        }
        if (quantity != '') {
      ...
      <?php if (count($physical_products) > 0) { ?>
        $(document).on("change", ".shipping_type", function() {
          ...
          $(".total-cart-price").html("Ksh " + total_cart_price + ".00");
        });
      <?php } ?>
    });
  </script>
