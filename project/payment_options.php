...
<input type="hidden" name="business" value="kevinkutoyi95@gmail.com">
...
<input type="hidden" name="return" value="http://localhost/ecommerce_project/paypal_order.php?c_id=<?php echo $customer_id; ?>">

<input type="hidden" name="cancel_return" value="http://localhost/ecommerce_project/index.php">
